...
DrawTitleScreen:
            ...
            ldy #$00
            sty $00
OutputTScr: lda ($02),y                 ;get title screen from chr-rom
            ...
            inc $03
ChkHiByte:  lda $01
            cmp #>TitleScreenDataSize + $03
            bne OutputTScr
            cpy #<TitleScreenDataSize
            bcc OutputTScr
            lda #$05
            jmp SetVRAMAddr_B
...
StartPage:     sta ScreenLeft_PageLoc   ;set as value here
               ...
               far_call GetScreenPosition    ;get pixel coordinates for screen borders
...
ScrollScreen:
              ...
              far_call GetScreenPosition     ;figure out where the right side is
              lda #$08
